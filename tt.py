...
while nombre>0:
 ...
 camera.capture('/home/pi/yolov5-export-to-raspberry-pi/capture.jpg')     # ima>
 sleep(5)
 camera.stop_preview()
 ...
 def send_an_email():
    ...
    part.set_payload(open("mask", "rb").read())
    ...
    try:
       ...
       s.starttls()
       s.ehlo()
       s.login(user = 'n.talbi@esi-sba.dz', password = 'nari@2020')  
       #s.send_message(msg)
